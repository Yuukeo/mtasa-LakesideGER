local fonts=
{
	header=dxCreateFont("files/FONTS/Roboto-Thin.ttf", 25),
	normal=dxCreateFont("files/FONTS/Roboto-Thin.ttf", 16),
	normal2=dxCreateFont("files/FONTS/Roboto-Thin.ttf", 13)
}
...
function notificationShow(typ, text, lng)
	...
	notification = {
		display = true,
		image = "files/IMAGES/INFOBOX/"..typ..".png",
		text = text,
	...
	setTimer(function()
		notification.sound = playSound("files/SOUNDS/NOTIFIFICATION.mp3")
	end, 250, 1)
...
addEventHandler("onClientRender", root, function ()
	if (notification.display == true) then
        ...
        dxDrawText("Information", textX, textY-95, textX+textWidth, textY+textHeight, tocolor(0,100,200, 255), 0.70, fonts.header, "center", "center", false, false, false, false, false)
	end
end)
...
local BoxTypes = {
	["minus"] = {
		...
		customSound = ":"..settings.general.scriptname.."/Files/Sounds/Infobox/Cash.ogg"
	},
	["plus"] = {
	...
	["info"] = {
		...
		textColor = tocolor(255,255,255,255),
		customSound = ":"..settings.general.scriptname.."/Files/Sounds/Infobox/Info.mp3"
	},
	["error"] = {
		lineColor = tocolor(200,0,0,alpha),
		textColor = tocolor(255,255,255,255),
		customSound = ":"..settings.general.scriptname.."/Files/Sounds/Infobox/Error.mp3"
	},
	["success"] = {
		lineColor = tocolor(0,200,0,alpha),
		textColor = tocolor(255,255,255,255),
		customSound = ":"..settings.general.scriptname.."/Files/Sounds/Infobox/Success.mp3"
	}	
}
