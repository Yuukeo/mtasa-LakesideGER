...
addEventHandler("open:houseleave",root,function()
	if(isLoggedin())then
		if(getElementData(lp,"ElementClicked")==false)then
			...
			Lakeside.Button[2]=dgsCreateButton(5,235,135,35,"Haus verlassen",false,Lakeside.Window[1],_,_,_,_,_,_,tocolor(50,50,50,255),tocolor(90,90,90,255),tocolor(10,10,10,255),true)
